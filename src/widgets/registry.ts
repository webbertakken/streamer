...
registerWidget({ id: "custom-text", name: "Custom text", component: CustomTextWidget, defaults: { x: 1024, y: 96, width: 544, height: 48 }, defaultConfig: { text: "Welcome to the stream!", fontSize: 24, colour: "#ffffff", fontFamily: "sans-serif", textAlign: "center" } });
