...
describe('splitMessageFragments', () => {
  ...
  it('splits text around a single emote', () => {
    const result = splitMessageFragments('Hello Kappa world', [{ id: '25', start: 6, end: 10 }])
  ...
  it('handles emote at the start of the message', () => {
    const result = splitMessageFragments('Kappa hello', [{ id: '25', start: 0, end: 4 }])
  ...
  it('handles emote at the end of the message', () => {
    const result = splitMessageFragments('hello Kappa', [{ id: '25', start: 6, end: 10 }])
