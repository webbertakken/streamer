...
function GuideLines() {
  ...
  return (
    <>
      ...
      <div
        className={GUIDE}
        style={{ left: MARGIN, top: 0, width: 1, height: '100vh', backgroundColor: GUIDE_COLOUR }}
      />
      <div
        className={GUIDE}
        style={{ left: '50%', top: 0, width: 1, height: '100vh', backgroundColor: GUIDE_COLOUR }}
      />
      <div
        className={GUIDE}
        style={{ right: MARGIN, top: 0, width: 1, height: '100vh', backgroundColor: GUIDE_COLOUR }}
      />
      {/* Horizontal: 8px from top, centre, 8px from bottom */}
      <div
        className={GUIDE}
        style={{ top: MARGIN, left: 0, height: 1, width: '100vw', backgroundColor: GUIDE_COLOUR }}
      />
      <div
        className={GUIDE}
        style={{ top: '50%', left: 0, height: 1, width: '100vw', backgroundColor: GUIDE_COLOUR }}
      />
      <div
        className={GUIDE}
        style={{
